...
function getRandomNumber(){
    const orgNum = Math.floor((Math.random() * 100) + 1);
    return orgNum
}
 ...
 */
function displayHistory(guessArr) {
  let index; // TODO
  let list = "<ul class='list-group'>";
  // *CODE GOES BELOW HERE *
  for(let i=0;i < guessArr.length; i++){
    list += `<li class='list-group-item'>You Guessed ${guessArr[i]}</li>`;
  }
  list += '</ul>';
